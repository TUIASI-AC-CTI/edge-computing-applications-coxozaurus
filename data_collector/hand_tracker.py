...
class LandmarkBbox(Bbox):
    ...
    def compute_rotation(self):
        ...
        x_0, y_0 = self.landmarks[0]  # Wrist
        x_1, y_1 = self.landmarks[9]  # Middle finger MCP
...
class HandLandmark:
    ...
    def __call__(self, frame):
        ...
        del landmarks[2::3]  # Drop z-component
...
class HandTracker:
    ...
    def _scale_bbox_to_frame(self, bbox, padding):
        ...
        if isinstance(bbox, LandmarkBbox):
            bbox.landmarks = bbox.landmarks * img_dim
            return bbox
    ...
    def __call__(self, frame):
        ...
        if self._previous_hand_bboxes:
            ...
            for hand_bbox in self._previous_hand_bboxes:
                ...
                lm_bbox.landmarks = cv2.perspectiveTransform(
                    lm_bbox.landmarks.reshape(-1, 1, 2), m_inv
                )
                lm_bbox.landmarks = lm_bbox.landmarks.reshape(-1, 2)
